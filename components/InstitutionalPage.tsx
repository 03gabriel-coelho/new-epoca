...
const InstitutionalPage: React.FC<InstitutionalPageProps> = ({ currentUser, onNavigateToHome, onNavigateToClient }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] font-sans text-slate-900">
      ...
      <header className="sticky top-0 z-50 bg-[#13733D] text-white shadow-md">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between gap-6">
          <div className="flex items-center gap-6">
             <Button variant="ghost" onClick={onNavigateToHome} className="pl-0 hover:bg-[#0F5C31] text-white rounded-full px-4">
      ...
      {/* Hero Section */}
      <div className="bg-[#E7F5EC] pt-16 pb-20 rounded-b-[3rem]">
         <div className="container mx-auto px-4 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <Badge variant="brand" className="mb-6 bg-white text-[#13733D] border-none shadow-sm px-4 py-1 text-xs uppercase tracking-widest">
                Nossa História
              </Badge>
         ...
         <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-6">
               <div className="text-center p-8 rounded-2xl bg-white shadow-sm border border-slate-100 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-14 h-14 mx-auto bg-[#E7F5EC] rounded-full flex items-center justify-center text-[#13733D] mb-6">
        ...
        <div className="container mx-auto px-4">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
                ...
                <div className="mt-8 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#E7F5EC] rounded-full text-[#13733D] text-xs font-bold">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
               <div className="lg:w-1/2">
                  ...
                  <h2 className="text-3xl md:text-5xl font-bold mb-6 text-slate-800 leading-tight">
                    Compromisso com o <br/> <span className="text-[#13733D]">Futuro do Planeta</span>
                  </h2>
               ...
               <div className="lg:w-1/2 relative">
                  <div className="relative bg-[#F2F2F2] p-10 rounded-3xl border border-slate-100">
                     <h4 className="font-bold text-xl mb-4 flex items-center gap-2 text-slate-800">
                        <ShieldCheck className="w-6 h-6 text-[#13733D]" /> Compliance & Ética
                     </h4>
                     ...
                     <Button className="w-full bg-[#13733D] hover:bg-[#0F5C31] text-white rounded-full h-12">
      ...
      <footer className="bg-[#0F5C31] text-white pt-10 pb-6 mt-12">
